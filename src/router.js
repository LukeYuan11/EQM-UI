...
const routes = [
  // MyClass
  {
    path: '/myclass/issubmit',
    Component: lazy(() => import('pages/myclass/issubmit')),
    exact: true,
  },  
  {
    path: '/myclass/isdue',
    Component: lazy(() => import('pages/myclass/isdue')),
    exact: true,
  },  
  {
    path: '/myclass/newclass/:classtype',
    Component: lazy(() => import('pages/myclass/newclass')),
    exact: true,
  },  
  // ManagerClass
  {
    path: '/managerclass/editclass',
    Component: lazy(() => import('pages/managerclass/editclass')),
    exact: true,
  },  
  {
    path: '/managerclass/editgrade',
    Component: lazy(() => import('pages/managerclass/editgrade')),
    exact: true,
  },  
  {
    path: '/managerclass/activitydetail/:ddd',
    Component: lazy(() => import('pages/managerclass/activitydetail')),
    exact: true,
  },  
  {
    path: '/managerclass/classdetail',
    Component: lazy(() => import('pages/managerclass/classdetail')),
    exact: true,
  },
  {
    path: '/managersetting/profile/:ddd',
    Component: lazy(() => import('pages/managersetting/profile')),
    exact: true,
  },  
  // Dashboards
  {
              ...
              <SwitchTransition>
                ...
                >
                  <Switch location={location}>
                    <Route exact path="/" render={() => <Redirect to="/myclass/issubmit" />} />
